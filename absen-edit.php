...
if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($koneksi, "UPDATE tb_absen SET nik='$nik', start='$start', finish='$finish', keterangan='$keterangan' WHERE id=$id");
...
$result = mysqli_query($koneksi, "SELECT * FROM tb_absen WHERE id=$id");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="img/img1.jpg">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Jam Kerja</h1>
                    <form method="POST" action="absen-edit.php">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="time" name="start" class="form-control" value='<?php echo $start; ?>'>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Jam Selesai</label>
                            <div class="col-sm-2">
                                <input type="time" name="finish" class="form-control" value='<?php echo $finish; ?>'>
                            </div>
                        </div>
                        <div class="form-group row">
