                            ...
                            <div class="table-responsive table-striped">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    while ($karyawan = mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td>" . $karyawan['umur'] . "</td>";
                                        echo "<td>" . $karyawan['alamat'] . "</td>";
                                        echo "<td>" . $karyawan['telepon'] . "</td>";
                                        echo "<td>" . $karyawan['jabatan'] . "</td>";
                                    ?>
                                    <td>
                                    <a href='edit.php?id=<?php echo $karyawan['id'];?>'>Edit</a>|<a href="#" data-toggle="modal" data-target="#deleteModal<?php echo $karyawan['id']; ?>">Delete</a>
                                    <!-- Delete Modal-->
                                    <div class="modal fade" id="deleteModal<?php echo $karyawan['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Yakin Hapus <?php echo $karyawan['nama']; ?> ?</div>
                                                <div class="modal-footer">
                                                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
                                                    <a class="btn btn-primary" href='delete.php?id=<?php echo $karyawan['id']; ?>'>Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
