            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $result = mysqli_query($koneksi, "INSERT INTO tb_karyawan(nama, nik, umur, alamat, telepon, jabatan) VALUES('$nama','$nik','$umur','$alamat','$telepon','$jabatan')");
                        $result2 = mysqli_query($koneksi, "INSERT INTO tb_user(username, password, role) VALUES('$nik', md5($nik), 'User')");
                        echo 
                        "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <center><strong>Data</strong> Berhasi Disimpan.</center>
