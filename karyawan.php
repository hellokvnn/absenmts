...
$query = "SELECT * FROM tb_karyawan WHERE nik='" . $username . "'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"> Selamat Datang <?php echo $fetch['nama']; ?></h1>
                    <h3>Aplikasi Absen PT. Megah Tata Seruni</h3>
                    <br>
                    <div class="row">
                        <!-- Card Example -->
