        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="izin-karyawan.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" accept='image/*' name="bukti">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $dirUpload = "images/";
                        $images = move_uploaded_file($namaSementara, $dirUpload.$namaFile);

                        $result = mysqli_query($koneksi, "INSERT INTO tb_izin(nama, nik, tanggal, keterangan, gambar) VALUES('$nama','$nik','$tanggal','$keterangan','$namaFile')");

                        echo 
                        "<div class='alert alert-success alert-dismissible fade show' role='alert'>
                        <center><strong>Form</strong> Berhasil Diajukan.</center>
